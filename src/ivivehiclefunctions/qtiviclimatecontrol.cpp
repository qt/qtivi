...
QtIVIClimateControl::QtIVIClimateControl(const QString &zone, QObject* parent)
    ...
    , m_airflowDirection(None)
    , m_qmlAirFlowDirection(QtIVIPropertyFactory<QtIVIClimateControl::AirflowDirection>::create(this,
    ...
    , m_qmlAirConditioning(QtIVIPropertyFactory<bool>::create(this,
    ...
    , m_heater(false)
    , m_qmlHeater(QtIVIPropertyFactory<bool>::create(this,
    ...
    , m_qmlAirRecirculation(QtIVIPropertyFactory<bool>::create(this,
    ...
    , m_qmlTargetTemperature(QtIVIPropertyFactory<int>::create(this,
    ...
    , m_seatCooler(0)
    , m_qmlSeatCooler(QtIVIPropertyFactory<int>::create(this,
    ...
    , m_seatHeater(0)
    , m_qmlSeatHeater(QtIVIPropertyFactory<int>::create(this,
    ...
    , m_qmlSteeringWheelHeater(QtIVIPropertyFactory<int>::create(this,
    ...
    , m_fanSpeedLevel(0)
    , m_qmlFanSpeedLevel(QtIVIPropertyFactory<int>::create(this,
...
void QtIVIClimateControl::onAirflowDirectionAttributeChanged(QtIVIPropertyAttribute<QtIVIClimateControl::AirflowDirection> airflowDirectionAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_airflowDirectionAttribute = airflowDirectionAttribute;
...
void QtIVIClimateControl::onAirConditioningAttributeChanged(QtIVIPropertyAttribute<bool> airConditioningEnabledAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_airConditioningAttribute = airConditioningEnabledAttribute;
...
void QtIVIClimateControl::onHeaterAttributeChanged(QtIVIPropertyAttribute<bool> heaterEnabledAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_heaterAttribute = heaterEnabledAttribute;
...
void QtIVIClimateControl::onAirRecirculationAttributeChanged(QtIVIPropertyAttribute<bool> airRecirculationEnabledAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_airRecirculationAttribute = airRecirculationEnabledAttribute;
...
void QtIVIClimateControl::onSteeringWheelHeaterAttributeChanged(QtIVIPropertyAttribute<int> steeringWheelHeaterAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_steeringWheelHeaterAttribute = steeringWheelHeaterAttribute;
...
void QtIVIClimateControl::onFanSpeedLevelAttributeChanged(QtIVIPropertyAttribute<int> fanSpeedAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_fanSpeedLevelAttribute = fanSpeedAttribute;
...
void QtIVIClimateControl::onTargetTemperatureAttributeChanged(QtIVIPropertyAttribute<int> temperatureAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_targetTemperatureAttribute = temperatureAttribute;
...
void QtIVIClimateControl::onSeatCoolerAttributeChanged(QtIVIPropertyAttribute<int> seatCoolerAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_seatCoolerAttribute = seatCoolerAttribute;
...
void QtIVIClimateControl::onSeatHeaterAttributeChanged(QtIVIPropertyAttribute<int> seatHeaterAttribute, const QString &zone)
{
    ...
    if (f->zone() != zone)
        return;
    f->m_seatHeaterAttribute = seatHeaterAttribute;
...
{
    return m_airConditioningAttribute;
}
...
{
    return m_airflowDirectionAttribute;
}
...
{
    return m_airRecirculationAttribute;
}
...
{
    return m_steeringWheelHeaterAttribute;
}
...
{
    return m_fanSpeedLevelAttribute;
}
...
{
    return m_targetTemperatureAttribute;
}
